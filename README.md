...
- (Ambros 16.10.2023)
    ...
    existing and which were generated. </p><br>
...
- (Yannik 23.10.2023)
    ...
    for loop before the try block. </p><br>
...
- (Ambros 16.10.2023)
    ...
    list files_start has been made will be deleted. </p>
        ...
        harder to understand and the main functions purpose is flow control, not storing and distributing dictionaries.</p><br>

---------------------------------------------------------------**Further**---------------------------------------------------------------

- (Ambros 24.10.2023)
    <p>What still could be added in the future:</p>
    <p>Information for the tests if the test has an error</p>
    <p>User option to get the time output without the cutting to get more detailed information</p>
    <p>Additional cleanup if program crashes unexpectedly -> having teardown always even if program crashes</p>
